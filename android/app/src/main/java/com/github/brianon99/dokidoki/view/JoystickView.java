package com.github.brianon99.dokidoki.view;
...
import com.github.brianon99.dokidoki.R;
...
public class JoystickView extends View
    ...
    */
    ...
    public interface OnMoveListener {
         ...
         * @param x X position relative to center and border
         * @param y Y position relative to center and border
         */
    ...
    */
    ...
    void callOnMove() {
        mCallback.onMove(
                (mPosX - mCenterX) / ((double) (mBorderRadius)),
                (mPosY - mCenterY) / ((double) (mBorderRadius))
        );
    }
